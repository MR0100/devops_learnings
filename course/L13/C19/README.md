...
- **T01 Cluster Upgrades** — Upgrade order: etcd → control plane → addons → workers. Skew policy: kubelet can be 2 minor behind apiserver; kube-proxy same minor as kubelet.
...
|---|---|
| apiserver | Newest |
| kubelet | Up to 2 minor behind apiserver |
