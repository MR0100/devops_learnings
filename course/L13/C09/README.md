...
- **T02 Sidecars** — Containers running alongside main. Use for: log shippers, service mesh proxies, secret injectors. Kubernetes 1.29+ has dedicated sidecar API (lifecycle handled).
