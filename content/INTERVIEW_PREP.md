...
Company-specific interview guidance for DevOps / SRE / Platform / Cloud roles. This is the strategic layer; the depth lives in [L29 — FAANGM Interview Mastery](L29/README.md) and the graded **Interview Prep** section at the bottom of every topic file.
...
|---|---|---|
| **Phone screen** | Linux/networking fundamentals, scripting, "debug this" | [L02](L02/README.md), [L03](L03/README.md), [L04](L04/README.md), [L29/C01](L29/C01/README.md) |
| **Coding** | DSA — yes, it's real for SRE/SWE-SRE | [L29/C02](L29/C02/README.md), [L06](L06/README.md) |
| **System Design** | The round that decides your level | [L28](L28/README.md), [L29/C03](L29/C03/README.md) |
| **Ops/Troubleshooting** | "The dashboard is red — go" | [L17](L17/README.md), [L19](L19/README.md), [L13](L13/README.md) |
| **Behavioral** | Scope, ownership, influence, conflict | [L29/C04](L29/C04/README.md) |
...
This is where most candidates under-level. The reusable structure (from [L29/C03](L29/C03/README.md)):
...
DevOps/SRE system-design favorites — all covered in [L28](L28/README.md):

- Design a CI/CD platform for 1000 engineers
- Design a multi-region active-active service (RTO/RPO) — see [L27](L27/README.md)
- Design a metrics/observability pipeline at 5M samples/sec — see [L17](L17/README.md)
- Design a globally consistent config/feature-flag system
- Design an internal developer platform (paved road) — see [L28](L28/README.md) platform chapters
...
Deep dives live in [L29/C05](L29/C05/README.md). Summary:
...
- Coding is real and graded against SWE standards. Don't skip [L29/C02](L29/C02/README.md).
...
- Strong Linux/systems internals signal in the early rounds — [L02](L02/README.md) pays off.
...
- Strong emphasis on operating real distributed systems and chaos/resilience — [L25](L25/README.md).

---

## Negotiation & Offer

Covered in [L29/C06](L29/C06/README.md):
...
| Week | Focus | Lectures |
|---|---|---|
| 1 | Fundamentals + ops | [L02](L02/README.md), [L03](L03/README.md), [L13](L13/README.md), [L17](L17/README.md), [L19](L19/README.md) |
| 2 | System design daily | [L28](L28/README.md), [L29/C03](L29/C03/README.md) |
| 3 | Coding + behavioral + company prep | [L29/C02](L29/C02/README.md), [L29/C04](L29/C04/README.md), [L29/C05](L29/C05/README.md) |
| 4 | Mock interviews + portfolio | [L30](L30/README.md) |
...
- [L29 — FAANGM Interview Mastery](L29/README.md) — the full lecture
- [L28 — System Design for DevOps](L28/README.md) — the decider round
- [L30 — Capstone Projects & Portfolio](L30/README.md) — proof of skill
