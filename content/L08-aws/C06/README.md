...
- Read replicas (async, up to 15 for MySQL/MariaDB/PostgreSQL; cross-region possible)
...
| One per primary | Up to 15 per primary (MySQL/MariaDB/Postgres) |
...
### Features
- Up to 15 read replicas (matches RDS MySQL/MariaDB/Postgres; lower latency replication)
