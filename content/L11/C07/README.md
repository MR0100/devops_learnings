...
|---|---|---|
| [T01](T01-Ansible-vs-Puppet-Chef-Salt.md) | Ansible vs Puppet vs Chef vs Salt | 0.5 hr |
| [T02](T02-Replace-IaC-Containers.md) | When to Replace with IaC + Containers | 0.5 hr |
