...
- **T08 Admission Control** — The apiserver enforcement point (post-authz, pre-etcd). Mutating vs validating; admission webhooks (failurePolicy fail-open/closed); ValidatingAdmissionPolicy + CEL, in-process and webhook-free (GA 1.30). The layer PSA, OPA/Kyverno, and image policy all plug into.
