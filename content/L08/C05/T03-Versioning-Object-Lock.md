...
# List / fetch a specific version
aws s3api list-object-versions --bucket b --prefix file
aws s3api get-object --bucket b --key file --version-id xyz file.bak

# Create a bucket with Object Lock (WORM); versioning auto-enabled
aws s3api create-bucket --bucket b --object-lock-enabled-for-bucket

# Apply compliance retention to an object
aws s3api put-object-retention --bucket b --key file \
