...
## SLSA Build Levels (v1.0 — Supply-Chain Levels for Software Artifacts)

| Level | Requirements |
|---|---|
| 0 | No guarantees (default) |
...
Current spec is **SLSA v1.0**: Build track is **L0–L3** (the old v0.1 L4 with
two-party review + hermetic builds was removed; review controls moved to a
separate Source track). Most companies aim for SLSA 2–3.
...
→ [L21 — Databases & Data Management for DevOps](../L21-databases/README.md)
